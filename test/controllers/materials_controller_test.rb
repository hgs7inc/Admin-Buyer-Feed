...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference('Material.count') do
      post materials_url, params: { material: { product_id: @material.product_id, supplier_id: @material.supplier_id } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { product_id: @material.product_id, supplier_id: @material.supplier_id } }
